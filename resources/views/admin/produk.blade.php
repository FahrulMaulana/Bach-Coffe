                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="padding: 20px;">
                                    <!-- Form Tambah Kasir -->
                                    <form id="tambahKasirForm" action="{{route('produk.store')}}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                            <div class="mb-3">
                                                <label for="nama_produk" class="form-label" style="font-weight: bold;">Nama
                                                    Produk</label>
                                                <input type="text" class="form-control" id="nama_produk" name="nama_produk"
                                                    placeholder="Nama Produk" required
                                                    style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                                            </div>
                                            <label for="harga_produk" class="form-label" style="font-weight: bold;">Harga
                                                Produk</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="promo" class="form-control " id="promo" name="promo"
                                                placeholder="Masukkan Promo" required
                                                style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="modal-footer" style=" display: flex; justify-content: flex-end; ">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                        style="font-size: 14px; padding: 8px 15px; border-radius: 8px;">Close</button>
                                    <button type="submit" class="btn btn-primary" form="tambahKasirForm"
                                        style="font-size: 14px; padding: 8px 15px; border-radius: 8px;">Simpan</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <form id="updateKasirForm" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <div class="mb-3">
                                                <label for="nama_produk" class="form-label" style="font-weight: bold;">Nama
                                                    Produk</label>
                                                <input type="text" class="form-control" id="nama_produk2" name="nama_produk"
                                                    placeholder="Nama Produk" required
                                                    style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                                            </div>
                                            <label for="harga_produk" class="form-label" style="font-weight: bold;">Harga
                                                Produk</label>
                                            <input type="text" class="form-control" id="harga_produk2" name="harga_produk"
                                                placeholder="Harga Produk" required
                                                style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                                        </div>
                                        <div class="mb-3">
                                            <label for="promo" class="form-label" style="font-weight: bold;">Promo</label>
                                            <input type="promo" class="form-control " id="promo2" name="promo"
                                                placeholder="Masukkan Promo" required
                                                style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                                        </div>
                                        <div class="mb-3">
                                ...
                                @else
                                    @foreach ($produk as $data)
                                        <tr class="align-middle">
                                            ...
                                            <td>{{ $data->promo }}</td>
                                            <td><img src="{{ asset('uploads/' . $data->foto) }}" alt="Foto {{ $data->nama_produk }}"
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" data-bs-toggle="modal"
                                                    ...
                                                    onclick="setDeleteData('{{ $data->id_produk }}')" class="text-danger"
                                                    title="Delete">
