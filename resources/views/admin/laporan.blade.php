...
<div class="app-content">
  ...
  <div class="container-fluid">
    ...
    @if ($errors->any() || session('error') || session('success'))
        <div class="alert alert-{{ session('success') ? 'success' : 'danger' }} alert-dismissible fade show mt-3" role="alert">
            @if ($errors->any())
                <ul class="mb-0">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-4">
                                    <img src="{{ asset('/build/assets/Animation - 1736668256622.gif') }}" 
                                         alt="No Data" style="width: 150px">
