                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- <input type="text" name="total_harga" id="total_harga" 
                                        class="form-control" readonly data-value="0"> -->
...
//             subtotal.value = hargaValue * Number(quantity.value);
//             calculateTotals();
//         }
//     }
// });
...
//         totalHarga += Number(input.value || 0);
//     });
...
//     totalInput.dataset.value = totalHarga;
//     document.getElementById('poin').value = Math.floor(totalHarga * 0.01);
// }
